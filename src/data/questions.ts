...
export const questions: Question[] = [
  makeQuestion(
    ...
    ['ความรักทำให้ทุกคนสมหวัง', 'ความรักและความลุ่มหลงนำไปสู่ความทุกข์', 'ความรักทำให้มนุษย์มีอำนาจ', 'ความรักทำให้ผู้ถูกสาปกลับสวรรค์'],
    1,
  ...
  makeQuestion(
    ...
    ['เพื่อให้เรื่องยาวขึ้น', 'เพื่อเลือกจังหวะและเสียงให้เหมาะกับอารมณ์และเหตุการณ์', 'เพื่อหลีกเลี่ยงการใช้บทสนทนา', 'เพื่อให้ทุกตัวละครพูดเหมือนกัน'],
    1,
  ...
  makeQuestion(
    ...
    ['ดื้อรั้นโดยไม่มีเหตุผล', 'ซื่อตรงต่อความรู้สึกของตนเอง', 'ต้องการทดสอบอำนาจสุเทษณ์', 'ไม่เข้าใจความหมายของความรัก'],
    1,
  ...
  makeQuestion(
    ...
    ['ไม่เข้าใจเวทมนตร์', 'ใช้อำนาจและอารมณ์เมื่อไม่ได้สิ่งที่ต้องการ', 'ต้องการช่วยมัทนา', 'ต้องการให้มายาวินรับผิดแทน'],
    1,
  ...
  makeQuestion(
    ...
    ['เกิดจากความสมัครใจของทั้งสองฝ่าย', 'เกิดจากคำสาปเหมือนกัน', 'เกิดจากมายาวินใช้มนตร์', 'เกิดเพราะพระฤๅษีสั่งให้รักกัน'],
    0,
  ...
  makeQuestion(
    ...
    ['ความรักที่ขาดการเคารพความสมัครใจ อาจกลายเป็นความทุกข์และการทำร้ายกัน', 'ผู้มีเวทมนตร์ย่อมได้ทุกสิ่งที่ต้องการ', 'ความรักที่ดีต้องมีการแข่งขัน', 'ผู้ที่ถูกสาปย่อมไม่มีทางเลือก'],
    0,
